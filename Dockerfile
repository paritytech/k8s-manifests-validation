...
LABEL io.parity.image.authors="devops-team@parity.io" \
    ...
    io.parity.image.source="https://github.com/paritytech/k8s-manifests-validation/blob/${VCS_REF}/Dockerfile" \
    io.parity.image.documentation="https://github.com/paritytech/k8s-manifests-validation/blob/${VCS_REF}/README.md" \
